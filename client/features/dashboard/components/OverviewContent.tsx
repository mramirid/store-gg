  ...
  return (
    <main className="main-wrapper">
      ...
      <style jsx>{`
        ...
        .latest-transaction .game-title-header {
          margin-top: 10px;
          margin-bottom: 10px;
        }

        .latest-transaction .game-title {
          white-space: nowrap;
          width: 135px;
          overflow: hidden;
        ...
        .latest-transaction .icon-status {
          width: 6px;
          height: 6px;
          border-radius: 999px;
        ...
        .latest-transaction .icon-status.pending {
          background-color: #febd57;
        }

        .latest-transaction .icon-status.success {
          background-color: #1abc9c;
        }

        .latest-transaction .icon-status.failed {
          background-color: #fe5761;
        }

        .top-up-categories .categories-card {
          background-color: #ffffff;
          padding: 1.875rem;
          border-radius: 1rem;
        }
