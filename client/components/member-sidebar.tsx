  ...
  return (
    <aside>
      <div className="content pt-50 pb-30 ps-30">
        ...
        <div className="menus">
          <div className="item active mb-30">
            ...
            <Link href="/member" className="item-title m-0">
          ...
          <div className="item mb-30">
            ...
            <Link href="/member/transactions" className="item-title m-0">
      ...
      <style jsx>{`
        ...
        .menus .item.active > svg path,
        .menus .item:hover > svg path {
          transition: all 0.2s linear;
          stroke: #4d17e2;
        }

        .menus .item.active::after {
          content: " ";
